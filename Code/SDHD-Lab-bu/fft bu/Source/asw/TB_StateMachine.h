...
#ifndef TB_STATEMACHINE_H
#define TB_STATEMACHINE_H
#include "global.h"
#include "project.h"
...
*/
typedef enum {
    ev_matlab_s = 0,    /**< MATLAB "s" UART Command. */
    ev_matlab_o,        /**< MATLAB "o" UART Command. */
    ev_pushButton,      /**< Push Button Pressed. */
    ev_adcDone,         /**< ADC Conversion Done. */
    ev_lastEvent        /**< Last Event. Placeholder for new events. */
} event_t;

typedef enum {
    IDLE = 0,        /**< MATLAB "s" UART Command. */
    SAMPLING,        /**< MATLAB "o" UART Command. */
    UART_TRANSFER,   /**< Push Button Pressed. */
    FFT_TRANSFER,    /**< TEST STATE TODO: Delete. */
} TB_SM_state_t;
...
*/
typedef struct {
    TB_SM_state_t state;                  /**< Test Bench State Machine State type */
    uint16_t samplesCount;                /**< Samples Count for ADC*/
    uint16_t samplesArray[ADC_SAMPLES];   /**< Samples Array*/
    uint16_t fftSamplesCountReal;
    uint16_t fftSamplesCountImaginary;
    uint8_t  transferState; //0-ADC data  1-fft Real data  2- fft Imaginary data 3- Done
    uint32_t fft_array[2*ADC_SAMPLES];    /**< Samples fft Array*/
    uint8_t  transferCount;               /**< Transfer Count*/
}TB_SM_t;
...
/**
 * TB_SM_run(TB_SM_t *const me, event_t event)
 * @param event_t* event
 * @return event
 */
...
/**
 * TB_SM_UpdateLEDStateStatus(TB_SM_state state)
 * @param TB_SM_state state
 * @return None
 */
void TB_SM_UpdateLEDStateStatus(TB_SM_state_t state);

#endif /* TB_STATEMACHINE_H */
